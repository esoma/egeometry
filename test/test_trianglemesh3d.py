...
def test_raycast(triangle_mesh_3d_cls, vector_3_array_cls, vector_3_cls):
    vertices = vector_3_array_cls(
        ...
        vector_3_cls(0, 1, 0),
        vector_3_cls(0, 0, 1),
        vector_3_cls(0.5, 0, 1),
        vector_3_cls(0, 0.5, 1),
    )
    ...
    assert results == [
        (
            vector_3_cls(0, 0, 1),
            1,
            (vector_3_cls(0, 0, 1), vector_3_cls(0.5, 0, 1), vector_3_cls(0, 0.5, 1)),
            0,
        ),
        (
            vector_3_cls(0, 0, 0),
    ...
    results = list(trimesh.raycast(vector_3_cls(0, 0, 0.5), vector_3_cls(0, 0, 1)))
    assert results == [
        (
            vector_3_cls(0, 0, 1),
            0.5,
