...
class DU8BoundedVolumeHierarchy2:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DU8BoundedVolumeHierarchy4:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DU8BoundedVolumeHierarchy8:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DU16BoundedVolumeHierarchy2:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DU16BoundedVolumeHierarchy4:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DU16BoundedVolumeHierarchy8:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DU32BoundedVolumeHierarchy2:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DU32BoundedVolumeHierarchy4:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DU32BoundedVolumeHierarchy8:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DUBoundedVolumeHierarchy2:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DUBoundedVolumeHierarchy4:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class DUBoundedVolumeHierarchy8:
    def __init__(self, items: Sequence[DBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[DBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: DVector3, direction: DVector3, /) -> Generator[int, None, None]: ...

class FU8BoundedVolumeHierarchy2:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FU8BoundedVolumeHierarchy4:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FU8BoundedVolumeHierarchy8:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FU16BoundedVolumeHierarchy2:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FU16BoundedVolumeHierarchy4:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FU16BoundedVolumeHierarchy8:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FU32BoundedVolumeHierarchy2:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FU32BoundedVolumeHierarchy4:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FU32BoundedVolumeHierarchy8:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FUBoundedVolumeHierarchy2:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FUBoundedVolumeHierarchy4:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...

class FUBoundedVolumeHierarchy8:
    def __init__(self, items: Sequence[FBoundingBox3d], /) -> None: ...
    @property
    def nodes(self) -> tuple[tuple[int | tuple[FBoundingBox3d, int], ...], ...]: ...
    def raycast(self, eye: FVector3, direction: FVector3, /) -> Generator[int, None, None]: ...
